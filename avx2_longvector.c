...
int main()
{
    __attribute__ ((aligned (32))) float float_array[16] = {100, 200, 300, 400, 500, 600, 700, 800, 101, 201, 301, 401, 501, 601, 701, 801};

    __m256 fv = _mm256_load_ps (float_array);
    __m256 fv2 = _mm256_load_ps (float_array+8);
